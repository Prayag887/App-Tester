...
-- Original released schema. FROZEN — do not edit.
-- Legacy dormant tables: projects, environments, devices, sessions.
...
CREATE INDEX IF NOT EXISTS transactions_session_time
...
CREATE TABLE IF NOT EXISTS body_artifacts (
    id TEXT PRIMARY KEY,
    transaction_id TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS interaction_windows (
    id TEXT PRIMARY KEY,
    session_id TEXT NOT NULL,
    payload_json TEXT NOT NULL
);
